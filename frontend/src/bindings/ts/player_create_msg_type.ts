 ...
 */
export namespace PlayerCreateMsg {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): PlayerCreateMsg {
    return PlayerCreateMsg.getTypeScriptAlgebraicType().deserialize(reader);
  }
