 ...
 */
export namespace AdminSignOutString {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): AdminSignOutString {
    return AdminSignOutString.getTypeScriptAlgebraicType().deserialize(reader);
  }
