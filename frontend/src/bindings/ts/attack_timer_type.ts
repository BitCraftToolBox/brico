...
export namespace AttackTimer {
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: AttackTimer): void {
    AttackTimer.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): AttackTimer {
    return AttackTimer.getTypeScriptAlgebraicType().deserialize(reader);
  }
