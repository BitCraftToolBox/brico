...
export type BuildingDespawn = {
  timer: __BuildingDespawnTimer,
};

/**
 * A namespace for generated helper functions.
 */
export namespace BuildingDespawn {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): BuildingDespawn {
    return BuildingDespawn.getTypeScriptAlgebraicType().deserialize(reader);
  }
