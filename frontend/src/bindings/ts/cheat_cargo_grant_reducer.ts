...
export type CheatCargoGrant = {
  request: __CheatCargoGrantRequest,
};

/**
 * A namespace for generated helper functions.
 */
export namespace CheatCargoGrant {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): CheatCargoGrant {
    return CheatCargoGrant.getTypeScriptAlgebraicType().deserialize(reader);
  }
