 ...
 */
export namespace InteriorSetCollapsed {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): InteriorSetCollapsed {
    return InteriorSetCollapsed.getTypeScriptAlgebraicType().deserialize(reader);
  }
