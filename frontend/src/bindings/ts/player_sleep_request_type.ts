 ...
 */
export namespace PlayerSleepRequest {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): PlayerSleepRequest {
    return PlayerSleepRequest.getTypeScriptAlgebraicType().deserialize(reader);
  }
