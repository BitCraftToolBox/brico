...
export type ImportProgressiveActionState = {
  records: __ProgressiveActionState[],
};

/**
 * A namespace for generated helper functions.
 */
export namespace ImportProgressiveActionState {
  /**
  ...
  */
  export function getTypeScriptAlgebraicType(): AlgebraicType {
    return AlgebraicType.createProductType([
      new ProductTypeElement("records", AlgebraicType.createArrayType(__ProgressiveActionState.getTypeScriptAlgebraicType())),
    ]);
  }
