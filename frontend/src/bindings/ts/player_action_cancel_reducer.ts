 ...
 */
export namespace PlayerActionCancel {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): PlayerActionCancel {
    return PlayerActionCancel.getTypeScriptAlgebraicType().deserialize(reader);
  }
