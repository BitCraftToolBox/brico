 ...
 */
export namespace SynchronizeTime {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): SynchronizeTime {
    return SynchronizeTime.getTypeScriptAlgebraicType().deserialize(reader);
  }
