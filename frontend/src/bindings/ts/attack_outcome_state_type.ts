 ...
 */
export namespace AttackOutcomeState {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): AttackOutcomeState {
    return AttackOutcomeState.getTypeScriptAlgebraicType().deserialize(reader);
  }
