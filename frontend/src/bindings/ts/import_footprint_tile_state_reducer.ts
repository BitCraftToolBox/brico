...
export type ImportFootprintTileState = {
  records: __FootprintTileState[],
};

/**
 * A namespace for generated helper functions.
 */
export namespace ImportFootprintTileState {
  /**
  ...
  */
  export function getTypeScriptAlgebraicType(): AlgebraicType {
    return AlgebraicType.createProductType([
      new ProductTypeElement("records", AlgebraicType.createArrayType(__FootprintTileState.getTypeScriptAlgebraicType())),
    ]);
  }
