 ...
 */
export namespace WorldGenVector2Int {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): WorldGenVector2Int {
    return WorldGenVector2Int.getTypeScriptAlgebraicType().deserialize(reader);
  }
