 ...
 */
export namespace TradeCancelServer {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): TradeCancelServer {
    return TradeCancelServer.getTypeScriptAlgebraicType().deserialize(reader);
  }
