...
export type CheatBuildingPlace = {
 ...
 */
export namespace CheatBuildingPlace {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): CheatBuildingPlace {
    return CheatBuildingPlace.getTypeScriptAlgebraicType().deserialize(reader);
  }
