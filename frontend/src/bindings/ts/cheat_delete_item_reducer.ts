 ...
 */
export namespace CheatDeleteItem {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): CheatDeleteItem {
    return CheatDeleteItem.getTypeScriptAlgebraicType().deserialize(reader);
  }
