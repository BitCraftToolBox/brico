...
export type ImportDimensionNetworkDescriptionState = {
  records: __DimensionNetworkState[],
};

/**
 * A namespace for generated helper functions.
 */
export namespace ImportDimensionNetworkDescriptionState {
  /**
  ...
  */
  export function getTypeScriptAlgebraicType(): AlgebraicType {
    return AlgebraicType.createProductType([
      new ProductTypeElement("records", AlgebraicType.createArrayType(__DimensionNetworkState.getTypeScriptAlgebraicType())),
    ]);
  }
