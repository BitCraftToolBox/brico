...
export type ImportVaultState = {
  records: __VaultState[],
};

/**
 * A namespace for generated helper functions.
 */
export namespace ImportVaultState {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): ImportVaultState {
    return ImportVaultState.getTypeScriptAlgebraicType().deserialize(reader);
  }
