 ...
 */
export namespace PlayerHousingUpdate {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): PlayerHousingUpdate {
    return PlayerHousingUpdate.getTypeScriptAlgebraicType().deserialize(reader);
  }
