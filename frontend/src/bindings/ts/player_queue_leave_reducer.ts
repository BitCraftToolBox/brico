 ...
 */
export namespace PlayerQueueLeave {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): PlayerQueueLeave {
    return PlayerQueueLeave.getTypeScriptAlgebraicType().deserialize(reader);
  }
