 ...
 */
export namespace EnemyDespawnTimer {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): EnemyDespawnTimer {
    return EnemyDespawnTimer.getTypeScriptAlgebraicType().deserialize(reader);
  }
