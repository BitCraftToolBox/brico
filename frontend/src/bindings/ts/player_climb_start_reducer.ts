 ...
 */
export namespace PlayerClimbStart {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): PlayerClimbStart {
    return PlayerClimbStart.getTypeScriptAlgebraicType().deserialize(reader);
  }
