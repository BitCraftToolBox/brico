...
export type TradeRemoveItem = {
  request: __PlayerTradeRemoveItemRequest,
};

/**
 * A namespace for generated helper functions.
 */
export namespace TradeRemoveItem {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): TradeRemoveItem {
    return TradeRemoveItem.getTypeScriptAlgebraicType().deserialize(reader);
  }
