...
export type TradeSwapPockets = {
  request: __PlayerTradeSwapPocketsRequest,
};

/**
 * A namespace for generated helper functions.
 */
export namespace TradeSwapPockets {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): TradeSwapPockets {
    return TradeSwapPockets.getTypeScriptAlgebraicType().deserialize(reader);
  }
