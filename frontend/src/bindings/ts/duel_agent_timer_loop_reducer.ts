...
export type DuelAgentTimerLoop = {
  timer: __DuelAgentTimer,
};

/**
 * A namespace for generated helper functions.
 */
export namespace DuelAgentTimerLoop {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): DuelAgentTimerLoop {
    return DuelAgentTimerLoop.getTypeScriptAlgebraicType().deserialize(reader);
  }
