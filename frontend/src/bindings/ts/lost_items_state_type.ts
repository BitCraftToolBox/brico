 ...
 */
export namespace LostItemsState {
  /**
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: LostItemsState): void {
    LostItemsState.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): LostItemsState {
    return LostItemsState.getTypeScriptAlgebraicType().deserialize(reader);
  }
