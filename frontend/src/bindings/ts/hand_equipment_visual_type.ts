 ...
 */
export namespace HandEquipmentVisual {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): HandEquipmentVisual {
    return HandEquipmentVisual.getTypeScriptAlgebraicType().deserialize(reader);
  }
