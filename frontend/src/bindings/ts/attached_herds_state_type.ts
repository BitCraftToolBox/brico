 ...
 */
export namespace AttachedHerdsState {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): AttachedHerdsState {
    return AttachedHerdsState.getTypeScriptAlgebraicType().deserialize(reader);
  }
