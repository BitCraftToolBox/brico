 ...
 */
export namespace RuinsEntityValuePair {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): RuinsEntityValuePair {
    return RuinsEntityValuePair.getTypeScriptAlgebraicType().deserialize(reader);
  }
