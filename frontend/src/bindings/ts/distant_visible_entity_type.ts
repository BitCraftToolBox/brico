 ...
 */
export namespace DistantVisibleEntity {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): DistantVisibleEntity {
    return DistantVisibleEntity.getTypeScriptAlgebraicType().deserialize(reader);
  }
