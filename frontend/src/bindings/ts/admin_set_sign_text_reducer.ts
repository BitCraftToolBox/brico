 ...
 */
export namespace AdminSetSignText {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): AdminSetSignText {
    return AdminSetSignText.getTypeScriptAlgebraicType().deserialize(reader);
  }
