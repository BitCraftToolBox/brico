 ...
 */
export namespace AdminCollapseRuin {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): AdminCollapseRuin {
    return AdminCollapseRuin.getTypeScriptAlgebraicType().deserialize(reader);
  }
