 ...
 */
export namespace AutoLogoutLoopTimer {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): AutoLogoutLoopTimer {
    return AutoLogoutLoopTimer.getTypeScriptAlgebraicType().deserialize(reader);
  }
