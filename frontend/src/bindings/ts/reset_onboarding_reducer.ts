 ...
 */
export namespace ResetOnboarding {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): ResetOnboarding {
    return ResetOnboarding.getTypeScriptAlgebraicType().deserialize(reader);
  }
