 ...
 */
export namespace PlayerNoteState {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): PlayerNoteState {
    return PlayerNoteState.getTypeScriptAlgebraicType().deserialize(reader);
  }
