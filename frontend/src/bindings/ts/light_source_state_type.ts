 ...
 */
export namespace LightSourceState {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): LightSourceState {
    return LightSourceState.getTypeScriptAlgebraicType().deserialize(reader);
  }
