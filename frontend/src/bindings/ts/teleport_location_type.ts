...
export type TeleportLocation = {
  ...
  locationType: __TeleportLocationType,
};

/**
 * A namespace for generated helper functions.
 */
export namespace TeleportLocation {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): TeleportLocation {
    return TeleportLocation.getTypeScriptAlgebraicType().deserialize(reader);
  }
