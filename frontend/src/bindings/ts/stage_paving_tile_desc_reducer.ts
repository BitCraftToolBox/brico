 ...
 */
export namespace StagePavingTileDesc {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): StagePavingTileDesc {
    return StagePavingTileDesc.getTypeScriptAlgebraicType().deserialize(reader);
  }
