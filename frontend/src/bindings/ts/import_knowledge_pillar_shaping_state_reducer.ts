...
export type ImportKnowledgePillarShapingState = {
  records: __KnowledgePillarShapingState[],
};

/**
 * A namespace for generated helper functions.
 */
export namespace ImportKnowledgePillarShapingState {
  /**
  ...
  */
  export function getTypeScriptAlgebraicType(): AlgebraicType {
    return AlgebraicType.createProductType([
      new ProductTypeElement("records", AlgebraicType.createArrayType(__KnowledgePillarShapingState.getTypeScriptAlgebraicType())),
    ]);
  }
