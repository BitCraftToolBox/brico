 ...
 */
export namespace ClaimTechUnlockTimer {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): ClaimTechUnlockTimer {
    return ClaimTechUnlockTimer.getTypeScriptAlgebraicType().deserialize(reader);
  }
