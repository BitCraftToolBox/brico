...
export type PlayerHousingDesc = {
  ...
  rank: number,
  name: string,
  templateBuildingId: number,
};

/**
 * A namespace for generated helper functions.
 */
export namespace PlayerHousingDesc {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): PlayerHousingDesc {
    return PlayerHousingDesc.getTypeScriptAlgebraicType().deserialize(reader);
  }
