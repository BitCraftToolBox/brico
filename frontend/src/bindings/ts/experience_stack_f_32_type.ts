 ...
 */
export namespace ExperienceStackF32 {
  /**
  ...
  */
  export function getTypeScriptAlgebraicType(): AlgebraicType {
    return AlgebraicType.createProductType([
      ...
      new ProductTypeElement("quantity", AlgebraicType.createF32Type()),
    ]);
  }
  ...
  export function deserialize(reader: BinaryReader): ExperienceStackF32 {
    return ExperienceStackF32.getTypeScriptAlgebraicType().deserialize(reader);
  }
