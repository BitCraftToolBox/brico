 ...
 */
export namespace PlayerEatRequest {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): PlayerEatRequest {
    return PlayerEatRequest.getTypeScriptAlgebraicType().deserialize(reader);
  }
