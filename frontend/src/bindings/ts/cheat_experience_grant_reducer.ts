...
export type CheatExperienceGrant = {
  request: __CheatExperienceGrantRequest,
};

/**
 * A namespace for generated helper functions.
 */
export namespace CheatExperienceGrant {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): CheatExperienceGrant {
    return CheatExperienceGrant.getTypeScriptAlgebraicType().deserialize(reader);
  }
