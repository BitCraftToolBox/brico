 ...
 */
export namespace AdminRenameClaim {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): AdminRenameClaim {
    return AdminRenameClaim.getTypeScriptAlgebraicType().deserialize(reader);
  }
