...
export type PlayerEmoteRequest = {
  emoteId: number,
  face: __OffsetCoordinatesSmallMessage | undefined,
};

/**
 * A namespace for generated helper functions.
 */
export namespace PlayerEmoteRequest {
  /**
  ...
  */
  export function getTypeScriptAlgebraicType(): AlgebraicType {
    return AlgebraicType.createProductType([
      ...
      new ProductTypeElement("face", AlgebraicType.createOptionType(__OffsetCoordinatesSmallMessage.getTypeScriptAlgebraicType())),
    ]);
  }
  ...
  export function deserialize(reader: BinaryReader): PlayerEmoteRequest {
    return PlayerEmoteRequest.getTypeScriptAlgebraicType().deserialize(reader);
  }
