  ...
  */
  export function getTypeScriptAlgebraicType(): AlgebraicType {
    return AlgebraicType.createProductType([
      ...
      new ProductTypeElement("skillType", AlgebraicType.createI32Type()),
  ...
  export function serialize(writer: BinaryWriter, value: SkillDesc): void {
    SkillDesc.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): SkillDesc {
    return SkillDesc.getTypeScriptAlgebraicType().deserialize(reader);
  }
