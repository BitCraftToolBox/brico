...
export type ClosedListingCollect = {
  request: __PlayerClosedListingCollectRequest,
};

/**
 * A namespace for generated helper functions.
 */
export namespace ClosedListingCollect {
  /**
  ...
  */
  ...
  export function deserialize(reader: BinaryReader): ClosedListingCollect {
    return ClosedListingCollect.getTypeScriptAlgebraicType().deserialize(reader);
  }
