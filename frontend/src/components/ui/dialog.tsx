...
const DialogOverlay = <T extends ValidComponent = "div">(
    ...
    return (
        <DialogPrimitive.Overlay
            class={cn(
                "fixed inset-0 z-50 bg-background/80 motion-safe:data-expanded:animate-in motion-safe:data-closed:animate-out data-closed:fade-out-0 data-expanded:fade-in-0",
                props.class
            )}
            {...rest}
        />
    ...
    return (
        <DialogPortal>
            ...
            <DialogPrimitive.Content
                class={cn(
                    "fixed left-1/2 top-1/2 z-50 grid max-h-screen w-full max-w-lg -translate-x-1/2 -translate-y-1/2 gap-4 overflow-y-auto border bg-background p-6 shadow-lg duration-200 motion-safe:data-expanded:animate-in motion-safe:data-closed:animate-out data-closed:fade-out-0 data-expanded:fade-in-0 motion-safe:data-closed:zoom-out-95 motion-safe:data-expanded:zoom-in-95 motion-safe:data-closed:slide-out-to-left-1/2 motion-safe:data-closed:slide-out-to-top-[48%] motion-safe:data-expanded:slide-in-from-left-1/2 motion-safe:data-expanded:slide-in-from-top-[48%] sm:rounded-lg",
                    props.class
                )}
                {...rest}
            >
